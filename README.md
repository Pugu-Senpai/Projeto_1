...
# \*\*Autor:\*\* Bruno Morais (\[GitHub](https://github.com/Pugu-Senpai))
...
# 1\. \*\*Sobre mim\*\*: perfil e objetivos

# 2\. \*\*Educação\*\*: percurso académico em formato de timeline

# 3\. \*\*Experiência\*\*: percurso profissional em formato de timeline

# 4\. \*\*Competências\*\*: barras de nível de confiança por área

# 5\. \*\*Hobbies\*\*: cartões com os meus interesses pessoais
...
# Não é preciso instalar nada. Basta abrir `index.html` num browser (Chrome, Firefox, Edge).
...
# \- Ícones: \[Material Symbols](https://fonts.google.com/icons) (Google Fonts)
